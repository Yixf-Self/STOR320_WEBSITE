---
title: "STOR 320 Tutorial on Web Scraping (Part 1)"
...
Using `str_detect()` we can identify cases in `City` where unwanted characters {"-","2","*"} make an appearance.
...
The unwanted characters {"-","2","*"} are special, but not our friends. In Wikipedia, they were used for indicating footnote information. We need to efficiently fix these occurrences by banishing them to the abyss.
