...
ggplot(TRAIN) + geom_histogram(aes(x=vert),fill="lightskyblue2") + theme_minimal()
```
...
```{r}
TRAIN %>% ggplot()+ geom_point(aes(x="",y=vert),fill="lightskyblue2") +
    geom_hline(yintercept=COEF0$beta0,alpha=0.3)+xlab("") +theme_minimal()
```
...
TEST %>% ggplot()+
  ...
  geom_point(aes(x="",y=34.53),stroke=2)
```

```{r}
ggplot(data=TRAIN) +
  geom_point(aes(x=shroom,y=vert),color="lightskyblue2") + theme_minimal()
```
...
```{r}
TRAIN %>% ggplot()+ geom_point(aes(x=shroom,y=vert)) +
    geom_abline(aes(intercept=COEF1A$beta0,slope=COEF1A$beta1),alpha=0.2,data=COEF1A)+theme_minimal()
```
...
ggplot(data=TRAIN) +
  geom_point(aes(x=shroom,y=vert),color="lightskyblue2") + theme_minimal() +
  geom_abline(aes(intercept=9.4,slope=1.24))
...
```{r}
ggplot(data=TRAIN) +
  geom_point(aes(x=exercise,y=vert),color="lightskyblue2") + theme_minimal()
```
...
ggplot(data=TRAIN) +
  geom_point(aes(x=exercise,y=vert),color="lightskyblue2") + theme_minimal() +
  geom_abline(aes(intercept=31,slope=0.85))
