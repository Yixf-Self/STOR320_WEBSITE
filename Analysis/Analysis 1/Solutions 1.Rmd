...
Answer *(1 Point)*: The average salary for employees in Linguistics is $79,935.17. 
...
Answer *(2 Points)*: There are 26 employees who have worked in Family Medicine for at most 5 years and are exempt from personnel act.
...
```{r}
salary.final %>%
  filter(Department=="Public Policy" & Job %in% c("Professor","Associate Professor","Assistant Professor")) %>%
...
Answer *(2 Points)*: Based on the combined scatter plot and fitted regression line, there seems to be a weak positive linear relationship between the years employed and the average salary. 
