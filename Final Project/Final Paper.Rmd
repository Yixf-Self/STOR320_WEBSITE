...
Four points of the final project is based on an average rank measuring overall contribution as seen by you and the other members of your group. Each group member should rank everyone in their group on a scale from 1 to the number of total members. There are no ties. If you give everyone the same rank, I will change yours to 1. Before the due date of the final paper, every member is required to upload a CSV document with two columns to Sakai. The first column should contain the full names of all members of the group, including yourself, and the second column should contain the rank that indicates the level of contribution. An example CSV template is provided on the course website. You are encouraged to download this template and modify the names and ranks. If there are any particular members that were extremely helpful or extremely useless, please send me an email. Your name and this information will remain private between me and you. If you fail to submit this ranking via Sakai, I will give you a ranking of 1 and the other members will be tied at four.
...
|Data: Adequately Describes Data|3 Points|
